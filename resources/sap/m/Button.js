...
sap.m.Button.prototype.getFocusDomRef=function(){return this.getDomRef("inner")};
...
sap.m.Button.prototype._activeButton=function(){this.$("inner").addClass("sapMBtnActive");if(this.getEnabled()){if(this.getIcon()&&this.getActiveIcon()&&this._image instanceof sap.m.Image){this._image.setSrc(this.getActiveIcon())}}};
sap.m.Button.prototype._inactiveButton=function(){this.$("inner").removeClass("sapMBtnActive");if(this.getEnabled()){if(this.getIcon()&&this.getActiveIcon()&&this._image instanceof sap.m.Image){this._image.setSrc(this.getIcon())}}};
