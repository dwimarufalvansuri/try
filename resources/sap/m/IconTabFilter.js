...
sap.m.IconTabFilter.prototype.invalidate=function(){var i;if(this.getParent()instanceof sap.m.IconTabHeader&&this.getParent().getParent()instanceof sap.m.IconTabBar){i=this.getParent().getParent();i.invalidate()}sap.ui.core.Element.prototype.invalidate.apply(this,arguments)};
