...
sap.m.Panel.prototype.setExpanded=function(e){this.setProperty("expanded",e,true);var $=this.$();$.find(".sapMPanelExpandableIcon").toggleClass("sapMPanelExpandableIconExpanded");$.find(".sapMPanelExpandablePart").toggle({});return this};
sap.m.Panel.prototype.onAfterRendering=function(){var $=this.$();if(this.getExpandable()&&!this.getExpanded()){$.find(".sapMPanelExpandablePart").hide()}};
