...
sap.ui.unified.Currency.prototype.getFormattedValue=function(){var p=this.getMaxPrecision()-this._oFormat.oLocaleData.getCurrencyDigits(this.getCurrency());var v=this._oFormat.format(this.getValue(),this.getCurrency());if(p==this.getMaxPrecision()&&this.getMaxPrecision()>0){v+=sap.ui.unified.Currency.PUNCTUATION_SPACE}if(p>0){v=jQuery.sap.padRight(v,sap.ui.unified.Currency.FIGURE_SPACE,v.length+p)}else if(p<0){v=v.substr(0,v.length+p)}return v};
